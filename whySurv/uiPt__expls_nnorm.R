...
fluidRow(style="margin:0px;",
    ...
    conditionalPanel("input.model_nnorm == 3",
        h4("What should I see?"),
        HTML("The Weibull parametric duration model assumes non-normal errors.  Specifically, it assumes Type I Extreme Value (minimum) errors&mdash;the same as the simulation's true DGP.  As a result, the Weibull estimates will now be"), em("unbiased"), "and ", em("efficient."),
        br(),br(),
        h4("Where should I look to see that?"),
