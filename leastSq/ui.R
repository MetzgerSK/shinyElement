ui <- fluidPage(
    ...
    titlePanel(HTML("Least Squares: The Intuition")),   # title for app
    theme = shinythemes::shinytheme("sandstone"),       # quick arbitrary theme
                ...
                sidebarPanel(
                   # Generate fake data
                    ...
                    conditionalPanel("input.dataGenButton != 0",
                        ...
                        div(id="bHalf",
                            hidden(h3(id="inf_instrText", "Now: find the slope and intercept that gives you the smallest \"point\" value")),
                            h3(id="formal_instrText", "Now: find the slope and intercept that gives you the smallest sum of squares value"),
                    ...
                    conditionalPanel("input.dataGenButton != 0",
                        ...
                        div(id="wrapper_llhInfo",
                            ...
                            div(id="inside_llh", class="ptTotal_llh",
                                conditionalPanel("input.solnButton==0",
                                    ...
                                    h4("Current sum of squared residuals value:", id="formal_ptTotal"),
                                    uiOutput("ssr")
                                ),                            
                                conditionalPanel("input.solnButton!=0",
                                    br(),
                            ...
                            div(id="inside_restore", class="llhBtn",
                                ...
                                bsTooltip("fullSSRButton", "Full SSR expression <br/> (NOTE: math incoming)", 
                        ...
                        div(id="wrapper_llhInfo",                
                            div(id="inside_llh", class="allTime",
                                ...
                                h4("Smallest SSR value (so far):", id="formal_bestGuess", class="bestGuess"),
                                hidden(h4("Best guess for smallest sum of squares value:", 
                                ...
                                conditionalPanel("input.solnButton!=0",
                                    ...
                                    h4("Actual SSR value:", id="formal_actual"),
                                    uiOutput("trueSSR"),
                                    uiOutput("trueEsts")
                                )
                            ),
                            div(id="inside_restore", style="margin-left: 5px;",
                                actionButton("restoreButton", "Restore", icon("upload"), 
                                                                style="color: #000; background-color: #FF8C00; height: 30px; padding: 0px 10px 0px 10px; font-size:80%;
