...
jqui_draggable(
    ui=bsModal("modal_fullSSR", "The full sum of squares calculation", "fullSSRButton", size = "large",
        ...
        h4("Generic: sum of squared residuals expression"),
        uiOutput("eq_fullSSR") %>% withSpinner(., type = spinType, color = spinColor),
        
        hr(),
        
        h4("Specific: sum of squared residuals expression"),
