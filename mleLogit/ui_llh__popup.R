...
jqui_draggable(
    bsModal("modal_fullLLH", "The full log-likelihood calculation", "fullLLHButton", size = "large",
        ...
        HTML("<a id='simp'></a>
            ...
            terms that eventually drop.  See <a href='#unsimp'>next section</a> 
            for unsimplified.)
              </p>"),
        ...
        HTML("<a id='unsimp'></a>
             <p>
            (For this specific dataset and your proposed parameter values, WITH 
             terms that eventually drop.  See <a href='#simp'>previous section</a> 
             for simplified.)"),
